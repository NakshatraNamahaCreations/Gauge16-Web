...
function Account() {
  ...
  console.log("one=========", allAccounts);

  const filterdata = allAccounts.filter((item) =>
    item.accountName.toLowerCase().includes(searchaccountname.toLowerCase())
  );
        ...
        <div className="container ">
          ...
          <div className="row m-auto ">
            <div className="col-md-9">
              <div className="row p-3">
                <div className="col-md-4">
                  <p className=" textbld">Customer Name</p>
                </div>
                <div className="col-md-8">
                  <Form.Control
                    className="shadow-sm"
